		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Consolidation PFP",
									"targetURL": "#comsapconsolidationpfp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapconsolidationpfp-display": {
								"semanticObject": "comsapconsolidationpfp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.consolidationpfp",
									"url": sap.ui.require.toUrl("com/sap/consolidationpfp")
								}
							}
						}
					}
